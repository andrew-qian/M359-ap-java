package Unit2.examples.Section2_6_2_7_NOTES;
...
public class Section2_6_2_7_NOTES {
    public static void main(String args[]) {
        ...
        /*
        since a comes before i in the alphabet, when we subtract its decimal value for
        the character (61-69) the difference is negative. This shows us that when we get
        a negative result, the colling string (one before the .) come first alphabetically
         */
        System.out.println(str2.compareTo(str1));
        /*
               since i comes after a in the alphabet, when we subtract its decimal value for
        the character (69-61) the difference is positive. This shows us that when we get
        a positive result, the colling string (one before the .) comes second alphabetically
         */
    }
